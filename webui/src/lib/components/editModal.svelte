...
<dialog
  ...
  <div
    class="w-full mx-auto relative bg-white dark:bg-gray-900 p-6 rounded-xl shadow-2xl text-gray-900 dark:text-gray-100 overflow-y-auto max-h-[calc(100vh-2rem)]">
    <button
      type="button"
